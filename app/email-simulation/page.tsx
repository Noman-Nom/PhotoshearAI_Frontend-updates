 ...
 * This page simulates an email inbox for development/testing purposes.
 * It intercepts "sent" emails from the application and displays them here
 * since we don't not have a real SMTP server in development.
 */
